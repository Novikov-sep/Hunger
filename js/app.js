...
if (iconMenu != null) {
   ...
   let menuhide = document.querySelector(".header__row");
   iconMenu.addEventListener("click", function (e) {
      if (unlock) {
         body_lock(delay);
         iconMenu.classList.toggle("_active");
         menuBody.classList.toggle("_active");
         menuhide.classList.toggle("_active");
      }
   });
};
function menu_close() {
   ...
   menuhide.classList.remove("_active");
}
//=================
//BodyLock
...
let slider_about = new Swiper('.specialties__slider', {
...
function mapInit(n = 1) {
   ...
   var locations = [
      [new google.maps.LatLng(51.5863303, -0.2502545)],
   ]
   var options = {
      zoom: 15,
      panControl: false,
